...
(SELECT empresa_id FROM empresa_receptora WEHRE nombre_corto_cdec = 'LIPIGAS'),
...
(SELECT barra_id FROM barra WHERE nombre = 'CURACAVI' AND voltaje = 12),'', NULL,'2024-04-01', '2028-03-31', NULL,432);
